...
<main>
    ...
    <header class="section_container header_container">
        <div class="header_content">
            ...
            <h4>Funcionalidades Admin.</h4>
            <h1><span>Aprende </span>como administrar <span>su página web</span></h1>
            <p>Bienvenido Administrador, aquí aprenderá como administrar su página web y observar todos los cambios dentro de ella
                viendo desde los usuarios que hay hasta la configuración más profunda de la web
            </p>
            <a href="accountAdmin.jsp"><button class="btn">Ver opciones</button></a>
        </div>
        <div class="header_image">
            <img src="img/personaConPaquete.png" alt="verOpciones">
        </div>
    </header>
